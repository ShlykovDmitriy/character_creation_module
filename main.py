...
from graphic_atrs.start_game_banner import run_screensaver


def attack(char_name: str, char_class: str) -> str:
    """
    Функция получает Имя и Класс персонажа.
    В зависимости от класса возвращает строку с нанесенным уроном.
    """
...
def defence(char_name: str, char_class: str) -> str:
    """
    Функция получает Имя и Класс персонажа.
    В зависимости от класса возвращает строку с блокированным уроном.
    """
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """
    Функция получает Имя и Класс персонажа.
    В зависимости от класса выводит необходимую информацию.
    """
    if char_class == 'warrior':
        return (
...
def start_training(char_name: str, char_class: str) -> str:
    """
    Функция получает имя и класс персонажа.
    Вывод информации о классе. Запускает треннировку в зависимости
    от команды вызывает функцию за нее отвечающую.
    """
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Функция определения имени и класса персонажа."""
    approve_choice: str = ''
    char_class: str = ''
